...
inputs. <span class="chip chip-tested">TESTED</span></p>
...
anywhere in this paper. <span class="chip chip-open">OPEN</span></p>
...
them. <span class="chip chip-open">OPEN</span></p>
"""
...
<code>ACCEPT</code>. <span class="chip chip-tested">TESTED</span></p>
</div>
...
<code>ACCEPT</code>. <span class="chip chip-proposed">PROPOSED</span></p>
...
required predicate to pass. <span class="chip chip-proposed">PROPOSED</span></div>
</div>
