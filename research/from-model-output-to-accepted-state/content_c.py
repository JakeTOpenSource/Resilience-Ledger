...
<h3>8.2 Finite activation, quotient, and frozen-oracle packets</h3>
...
<p>The frozen-oracle packet fixed one prompt, one response schema, a nine-group
oracle, and a twelve-function semantic rubric before three responses were requested.
The responses were requested under <code>gpt-5.6-sol/high</code>,
...
<p>The packets share a recorded operator, orchestration platform, prompt, and response
...
either public packet locators or retained source IDs. <span class="chip chip-tested" data-claim="039">TESTED</span></p>
...
<p>Two systems published in 2026 share this design's spine and are named directly.
...
<p>The Leiden Declaration states the corresponding obligation from the research side
...
not endorse this work.</p>

<p>Two narrower separations remain. First, UNRESOLVED is a condition about evidence,
...
ESAA is binary, emitting <code>output.rejected</code> on contract violation [49].
...
<code>INVALID_POLICY</code> rather than a vacuous pass. Second, observation and
...
priority claim. <span class="chip chip-open" data-claim="062">OPEN</span></p>
...
of everything checked. <span class="chip chip-tested" data-claim="040">TESTED</span></p>
...
<span class="chip chip-tested" data-claim="041">TESTED</span></p>
...
The event decision was <code>DEFER</code>. <span class="chip chip-observed" data-claim="042">OBSERVED</span></p>
...
truth, durability, or any future state. <span class="chip chip-observed" data-claim="043">OBSERVED</span></p>
...
not advance accepted state. <span class="chip chip-observed" data-claim="044">OBSERVED</span></p>
...
<span class="chip chip-open" data-claim="045">OPEN</span></p>

<h3>9.4 Finite representations and frozen-oracle results</h3>
...
<code>p</code>.</td>
<td>All three BP-001 responses returned <code>BLOCK</code> when
...
<p>The BP-001 evaluator made 27 exact comparisons: nine frozen
...
<span class="chip chip-tested" data-claim="046">TESTED</span></p>
...
<span class="chip chip-open" data-claim="047">OPEN</span></p>
...
<span class="chip chip-tested" data-claim="048">TESTED</span></p>
...
in one stream cannot be compared axis by axis. <span class="chip chip-open" data-claim="049">OPEN</span></p>
...
<span class="chip chip-observed" data-claim="050">OBSERVED</span></p>
...
<span class="chip chip-open" data-claim="051">OPEN</span></p>
</div>
...
<span class="chip chip-observed" data-claim="052">OBSERVED</span></p>
...
<span class="chip chip-tested" data-claim="053">TESTED</span></p>
...
<p>The frozen-oracle packet is a three-response check, not a model
...
between them. <span class="chip chip-open" data-claim="054">OPEN</span></p>
...
<p>I do not know whether this combination is novel in an academic sense. Section 8.3
...
<li>ESAA: Event Sourcing for Autonomous Agents in LLM-Based Software Engineering. arXiv:2602.23193, 2026. <a href="https://arxiv.org/abs/2602.23193">arxiv.org/abs/2602.23193</a>.</li>
<li>AgentBound: Verifiable Behavioral Governance for Autonomous AI Agents. arXiv:2606.30970, 2026. <a href="https://arxiv.org/abs/2606.30970">arxiv.org/abs/2606.30970</a>.</li>
<li>Leiden Declaration on Artificial Intelligence and Mathematics. Working group convened by J. Portegies, Eindhoven University of Technology. June 2026, endorsed by the International Mathematical Union. <a href="https://leidendeclaration.ai/">leidendeclaration.ai</a>.</li>
</ol>
</div>
...
false-plus-unknown public fixture. <span class="chip chip-proposed" data-claim="055">PROPOSED</span></p>
...
is not a tested result. <span class="chip chip-proposed" data-claim="056">PROPOSED</span></p>
...
<span class="chip chip-proposed" data-claim="057">PROPOSED</span></div>
</div>
...
<span class="chip chip-open" data-claim="058">OPEN</span></p>
...
<span class="chip chip-proposed" data-claim="059">PROPOSED</span></p>
...
<p>The included source and receipt are the complete public evidence boundary for this
...
history. Other modules imported by <code>ZeroState.lean</code> are outside A.8 and do
not support the quotient claim. Clean-room reconstruction of the pinned package
environment remains open. <span class="chip chip-open" data-claim="060">OPEN</span></p>
...
<li>the term <b>frozen-oracle packet</b> for BP-001: the prompt-response evaluation
whose oracle and semantic rubric were fixed before collection and withheld from
responders; the term does not imply blinded assignment or blinded assessment;</li>
...
<p class="tnote">Verification note: <code>REPRODUCE.md</code> gives the clean-clone
...
<tr><td>BP-001 prompt</td><td>owner-review packet, 1,662 bytes<br><code>evidence/<wbr>blind-prompt/<wbr>PROMPT.md</code>; legacy locator retained for receipt continuity</td><td class="mono">6b0628ef41bdf3b8d871238aa39ac44af43576887d5e0b1ed44ad8e7cdeccaf1</td></tr>
<tr><td>BP-001 response schema</td><td>retained source <code>BP-SCHEMA-001</code>, 1,808 bytes; not included in this minimized packet</td><td class="mono">3656a398b63255eefc2121327da65884cca365a965f5601d6eab18e33aa0a505</td></tr>
<tr><td>BP-001 run manifest</td><td>retained source <code>BP-RUN-MANIFEST-001</code>, 2,175 bytes; not included in this minimized packet</td><td class="mono">5e104bff1ccd4cffc684667f84783a06414cfb7177da1b43717f0c90145e2f63</td></tr>
<tr><td>BP-001 evaluator report</td><td>retained source <code>BP-EVALUATOR-001</code>, 20,945 bytes; quote-bearing report not included</td><td class="mono">de2c28735762a153602fc6e4bb777520c2aa3c687837e3f64b6277c459d67fe9</td></tr>
<tr><td>BP-001 packet receipt</td><td>retained source <code>BP-RECEIPT-001</code>, 4,488 bytes; private packet receipt not included</td><td class="mono">537e8cc13e8425e53304dd22637df6d186efa4df0be0f910a747b5f78632c815</td></tr>
...
<h2><span class="num">D</span>Reproduction and revision lineage</h2>

<p>Clean-clone packet verification is documented in <code>REPRODUCE.md</code>. From
...
and packet-local <code>.gitattributes</code> rules disable line-ending conversion so
a normal Windows checkout does not create a false byte mismatch. A clean-clone test
with <code>core.autocrlf=true</code> passed before this revision was prepared. This
...
authority, safety, or fitness. <span class="chip chip-tested" data-claim="061">TESTED</span></p>

<p>Demotion test 6 now has a machine-readable review surface. The release contains a
marker-blind <code>claims.json</code>, a separate <code>author-markers.json</code>, and
<code>reviewer-markers.template.json</code>. The register excludes the four Table 1
...
becomes <code>CONTESTED/HOLD</code>;
a missing assignment is <code>INCOMPLETE</code>. No comparison can auto-promote a
claim. Because the marked manuscript is public, the separation is a procedural blind,
not cryptographic secrecy.</p>

<p><code>CHANGELOG.md</code> retains the fuller packet history. In summary:
...
scientific priority or acceptance.</p>

<div class="footer-note">
Jake Tiller &middot; From Model Output to Accepted State &middot; owner-review draft v4,
