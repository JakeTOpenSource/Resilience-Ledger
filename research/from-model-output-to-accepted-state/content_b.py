...
<span class="chip chip-proposed" data-claim="015">PROPOSED</span></p>
...
<span class="chip chip-tested" data-claim="016">TESTED</span></p>
...
<span class="chip chip-proposed" data-claim="017">PROPOSED</span></p>
...
calibration. <span class="chip chip-proposed" data-claim="018">PROPOSED</span></p>
"""
...
keys outside the pinned corpus, whose keys are ASCII. <span class="chip chip-tested" data-claim="019">TESTED</span></div>
</div>
...
<span class="chip chip-tested" data-claim="020">TESTED</span></p>
...
<tbody>
<tr><td class="num">1</td><td>Records satisfy a declared structural schema</td><td><span class="chip chip-tested" data-claim="021">TESTED</span></td></tr>
<tr><td class="num">2</td><td>One implementation repeats its own result</td><td><span class="chip chip-tested" data-claim="022">TESTED</span></td></tr>
<tr><td class="num">3</td><td>Cross-language ports agree on pinned inputs</td><td><span class="chip chip-tested" data-claim="023">TESTED</span></td></tr>
<tr><td class="num">4</td><td>Another team reproduces from a minimized packet</td><td><span class="chip chip-open" data-claim="024">OPEN</span></td></tr>
<tr><td class="num">5</td><td>A new study obtains fresh evidence for the question</td><td><span class="chip chip-open" data-claim="025">OPEN</span></td></tr>
<tr><td class="num">6</td><td>The result stays informative in another system</td><td><span class="chip chip-open" data-claim="026">OPEN</span></td></tr>
</tbody></table>
...
<span class="chip chip-tested" data-claim="027">TESTED</span></p>
...
conformance. <span class="chip chip-proposed" data-claim="028">PROPOSED</span></div>
</div>
...
<tr><td>Artifact-internal structure</td><td>One artifact satisfies its declared shape and consistency rules</td>
    <td>A coherent false record or a faulty rule can pass</td><td><span class="chip chip-tested" data-claim="029">TESTED</span></td></tr>
<tr><td>Cross-implementation replay</td><td>Separate implementations produce the same projection from the same bytes</td>
    <td>A shared specification, fixture, or source record can be wrong in common</td><td><span class="chip chip-tested" data-claim="030">TESTED</span></td></tr>
<tr><td>Physical observation</td><td>A declared physical quantity covaries with a declared execution condition</td>
    <td>Instrument, driver, clock, host, custody, calibration, and inference model</td><td><span class="chip chip-open" data-claim="031">OPEN</span></td></tr>
</tbody></table>
...
<span class="chip chip-open" data-claim="032">OPEN</span></p>
...
I make no fixture claim for it. <span class="chip chip-proposed" data-claim="033">PROPOSED</span></p>
...
<span class="chip chip-proposed" data-claim="034">PROPOSED</span></p>
...
<span class="chip chip-proposed" data-claim="035">PROPOSED</span></p>
...
interchangeable. <span class="chip chip-proposed" data-claim="036">PROPOSED</span></p>
...
<span class="chip chip-proposed" data-claim="037">PROPOSED</span></p>
...
general six-predicate decision contract. <span class="chip chip-proposed" data-claim="038">PROPOSED</span></p>
